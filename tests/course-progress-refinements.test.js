...
test('course progress treatment is mobile friendly and shipped offline',()=>{
  ...
  assert.match(index,/course-progress-refinements\.css\?v=5\.1\.107/);
  assert.match(index,/course-progress-refinements\.js\?v=5\.1\.107/);
  assert.match(index,/Zin · V5\.1\.107/);
