...
test('the top menu shows four study destinations and keeps the rest inside Progress',()=>{
 ...
 assert.doesNotMatch(progressNav,/id:'report'/);
 assert.match(progressNav,/id:'evidence'/);
 assert.match(progressNav,/openPane\('evidence'\)/);
 assert.match(progressNav,/classList.remove\('active'\)/);
 assert.match(flashcards,/open-flashcard-report/);
 assert.match(reporting,/back-to-flashcards/);
});
