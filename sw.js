...
// Migration lineage: v5.1.5 → v5.1.6 → v5.1.7 → v5.1.8 → v5.1.9 → v5.1.10 → v5.1.11 → v5.1.12 → v5.1.13 → v5.1.14 → v5.1.15 → v5.1.16 → v5.1.17 → v5.1.18 → v5.1.19 → v5.1.20 → current v5.1.21.
const CACHE="dutch-v5.1.21-20260910"+'-'+self.registration.scope;
const ASSETS=["./","./index.html","./manifest.webmanifest","./src/content/foundation-a1.json","./src/content/packs.json","./src/content/registry.js","./src/content/vocabulary.json","./src/engine/exercises.js","./src/engine/flashcards.js","./src/engine/flashcard-session.js","./src/engine/integrations.js","./src/engine/learner.js","./src/engine/persistence.js","./src/engine/scheduler.js","./src/engine/scoring.js","./src/engine/sentence-bank.js","./src/engine/util.js","./src/engine/word-recall.js","./src/ui/peek.js","./src/ui/app.js","./src/ui/flashcards-preview.js","./src/ui/flashcard-completion-sync.js","./src/ui/flashcard-sandbox.js","./src/ui/flashcards-preview.css","./src/ui/sentence-bank-client.js","./src/ui/sentence-bank-ui.js","./src/ui/sentence-bank-ui.css","./src/ui/speech.js","./src/ui/styles.css","./src/ui/v51.css","./src/ui/v51.js","./icons/icon-192.png","./icons/icon-512.png"];
