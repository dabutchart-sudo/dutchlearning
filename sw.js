...
// Migration lineage: v5.1.5 → v5.1.6 → v5.1.7 → v5.1.8 → v5.1.9 → v5.1.10 → v5.1.11 → v5.1.12 → v5.1.13 → v5.1.14 → v5.1.15 → v5.1.16 → v5.1.17 → v5.1.18 → v5.1.19 → current v5.1.20.
const CACHE="dutch-v5.1.20-20260910"+'-'+self.registration.scope;
