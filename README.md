...
- The front screen now displays the build version and automated coverage checks that the visible version matches `package.json`.
- The service worker cache is updated for V5.1.6 and includes the new Flashcards runtime assets.
